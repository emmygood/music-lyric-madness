...
| --- | --- | --- |
| Chrome | ![screenshot](documentation/validation/chrome.png) | Works as expected |
| Edge | ![screenshot](documentation/validation/medge.png) | Works as expected |
| Safari | ![screenshot](documentation/validation/safari1.PNG) | Works as expected |
| Safari | ![screenshot](documentation/validation/safari2.PNG) | Works as expected |
